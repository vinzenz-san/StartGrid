...
export const de: Record<TranslationKey, string> = {
  ...
  'background.unsplash.sourceTopics':      'Themen',
  'background.unsplash.sourceSearch':      'Suche',
  'background.unsplash.sourceRandom':      'Zufällig',
  'background.unsplash.searchPlaceholder': 'z. B. dunkler Wald, Cyberpunk-Stadt…',
  'background.unsplash.randomNote':        'Ein zufälliges Foto aus Unsplashs redaktionellem Feed.',
  'background.unsplash.changePhotoEvery':  'Foto wechseln alle',
  ...
  'background.unsplash.interval.15min':  '15 Min.',
  'background.unsplash.interval.30min':  '30 Min.',
  'background.unsplash.interval.1hour':  '1 Stunde',
  'background.unsplash.interval.4hours': '4 Stunden',
  'background.unsplash.interval.12hours':'12 Stunden',
  'background.unsplash.interval.24hours':'24 Stunden',
  ...
  'widget.bookmarkFolder.showIcons':        'Symbole anzeigen',
  'widget.bookmarkFolder.compactMode':      'Kompaktmodus',
  ...
  'widget.quicklinks.on':                   'An',
  'widget.quicklinks.off':                  'Aus',
