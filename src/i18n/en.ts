export const en = {
  ...
  'background.unsplash.sourceTopics':      'Topics',
  'background.unsplash.sourceSearch':      'Search',
  'background.unsplash.sourceRandom':      'Random',
  'background.unsplash.searchPlaceholder': 'e.g. dark forest, cyberpunk city…',
  'background.unsplash.randomNote':        "A random photo from Unsplash's editorial feed.",
  'background.unsplash.changePhotoEvery':  'Change photo every',
  ...
  'background.unsplash.interval.1hour':  '1 hour',
  'background.unsplash.interval.4hours': '4 hours',
  'background.unsplash.interval.12hours':'12 hours',
  'background.unsplash.interval.24hours':'24 hours',
  ...
  'widget.bookmarkFolder.showIcons':        'Show icons',
  'widget.bookmarkFolder.compactMode':      'Compact mode',
  ...
  'widget.quicklinks.on':                   'On',
  'widget.quicklinks.off':                  'Off',
